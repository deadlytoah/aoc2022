//
//  Day14Part1View.swift
//  aoc2022
//
//  Created by Hee Suk Shin on 2023/2/15.
//

import SwiftUI
import SwiftyZeroMQ

struct Day14Part1View: View {
    ...
    func run(_ input: String, withVisualisation: Bool) throws -> String {
        return try RegolithReservoirWrapper.runPart1(input, withVisualisation: withVisualisation)
    }
}
